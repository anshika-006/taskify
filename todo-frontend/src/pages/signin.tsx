...
export default function Signin() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center min-w-full min-h-screen ">
      <div className="bg-slate-800 p-8 rounded-lg shadow-lg w-full max-w-md rounded-xl shadow-xl">
        <h2 className="text-2xl font-bold text-white text-center mb-6">Sign In to Taskify</h2>
